...
namespace Lykke.Service.EthereumCore.Client
{
    ...
    public partial interface IEthereumCoreAPI : System.IDisposable
    {
        ...
        /// </param>
        Task<HttpOperationResponse<object>> ApiAirlinesErc20depositsGetWithHttpMessagesAsync(string apiKey, string userAddress = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiAirlinesErc20depositsPostWithHttpMessagesAsync(string apiKey, string userAddress = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiAirlinesErc20depositsTransferPostWithHttpMessagesAsync(string apiKey, AirlinesTransferFromDepositRequest request = default(AirlinesTransferFromDepositRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiBlockPostWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiErc20BlackListByAddressGetWithHttpMessagesAsync(string address, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<ApiException>> ApiErc20BlackListByAddressDeleteWithHttpMessagesAsync(string address, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<ApiException>> ApiErc20BlackListPostWithHttpMessagesAsync(EthereumAddressRequest model = default(EthereumAddressRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
