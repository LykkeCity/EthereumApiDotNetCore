...
namespace Lykke.Service.EthereumCore.Client.Models
{
    ...
    public partial class CashoutModel
    {
        ...
        /// Initializes a new instance of the CashoutModel class.
        /// </summary>
        public CashoutModel(System.Guid id, string sign = default(string), string coinAdapterAddress = default(string), string fromAddress = default(string), string toAddress = default(string), string amount = default(string))
        {
            Sign = sign;
            Id = id;
