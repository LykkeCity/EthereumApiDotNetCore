...
using Lykke.Job.EthereumCore.Core.Settings;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                builder.RegisterModule(new JobModule(appSettings.CurrentValue.EthereumCoreJob, appSettings.Nested(x => x.EthereumCoreJob.Db), Log));
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.EthereumCoreJob.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "EthereumCoreJobLog", consoleLogger),
                consoleLogger);
