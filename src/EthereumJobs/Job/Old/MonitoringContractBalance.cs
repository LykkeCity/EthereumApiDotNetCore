...
//                        await _logger.WriteWarningAsync("MonitoringContractBalance", "Execute", "", $"User contract {userContract.Address} has {balance} ETH in {userContract.BalanceNotChangedCount} of 3 check");
